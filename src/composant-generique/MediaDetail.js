...
const MediaDetail = (props) => {
  ...
  if (props.photoselected.lienExterieur) {
    var lienExterieur = (
     ...
     <span> Retrouver tout ici : </span> <a href={props.photoselected.lienExterieur}  target="_blank"> {props.photoselected.lienExterieur}</a>    </div>
    );
  ...
  if (props.photoselected.urlPremiereVideo) {
    var premierVideo = (
       ...
       <iframe className="iframe-detail"  src={props.photoselected.urlPremiereVideo} frameborder="0"
  ...
  if (props.photoselected.urlSecondeVideo) {
    var secondeVideo = (
      <div className="space-media"> 
          ...
          <iframe className="iframe-detail"  src={props.photoselected.urlSecondeVideo} frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; 
       gyroscope; picture-in-picture" allowfullscreen></iframe>
